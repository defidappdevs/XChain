...
import FarmsModal from './FarmsModal'
...
const StyledRoiModal = styled.div`
  // border-bottom: 1px solid ${({ theme }) => theme.colors.borderColor};
  // padding: 24px;
`

const RoiModal = ({children }: RoiModalProps) => {
  const [onPresentSettings] = useModal(<FarmsModal />)

  return (
    <>
        <IconButton variant="text" onClick={onPresentSettings} style={{marginLeft:"100px"}}>
          <Farmmodalicon />
        </IconButton>
