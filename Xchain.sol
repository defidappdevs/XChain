...
// XCHAIN with Governance.
contract XCHAIN is BEP20('Goose Golden Egg', 'EGG') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying XCHAINS (not scaled);
